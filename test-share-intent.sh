...
# Test Share Intent Script for Tagmentia App
# This script sends share intents to the Android app using ADB

PACKAGE_NAME="app.lovable.tagmentia"
ACTIVITY_NAME="app.lovable.tagmentia.MainActivity"
...
adb shell am start -a android.intent.action.SEND \
  -t "text/plain" \
  --es android.intent.extra.TEXT "Check out this video: https://www.youtube.com/watch?v=dQw4w9WgXcQ" \
  -n "$PACKAGE_NAME/$ACTIVITY_NAME"
...
echo "Check the app logs with: adb logcat | grep MainActivity"
