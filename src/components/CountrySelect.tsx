    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button
          ...
          aria-expanded={open}
          className={cn(
            "w-full justify-between bg-muted/50 border-border text-left font-normal hover:bg-muted/70 focus:ring-2 focus:ring-primary focus:ring-offset-2",
      ...
      <PopoverContent className="w-full p-0 z-50 bg-background border border-border shadow-md" align="start">
